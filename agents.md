# AGENTS.md - Lightning P2P File Transfer

## Overview

Lightning P2P is a P2P file sharing app. Rust backend (iroh + Tauri v2), React/TypeScript frontend.
Goal: high-throughput direct file transfers of any size without a cloud upload step.
...
# Run benchmarks
cargo bench --manifest-path src-tauri/Cargo.toml --bench transfer_bench
```
